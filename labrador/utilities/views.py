...
blueprint = Blueprint('utilities', __name__, static_folder='../static')
...
@blueprint.route('/utilities', methods=['GET', 'POST'])
def home():
    """Home page."""
    ...
    if request.method == 'POST':
        if form.validate_on_submit():
            ...
            flash_errors(form)
    return render_template('utilities/home.html', form=form, page="utilities", left="search", right="")
